...
<head>
    ...
    <title>Registro - COMPUPLUSS</title>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        ...
                                        <p class="text-center small">Ingrese sus datos personales para crear una cuenta
                                        </p>
                                    </div>
                                    ...
                                    <form class="row g-3 needs-validation" novalidate>
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                <span class="input-group-text bi bi-file-person"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                <span class="input-group-text bi bi-file-person"
                                                    id="inputGroupPrepend"></span>
                                                <input type="text" name="name" class="form-control" id="yourLastName"
                                                    required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                <span class="input-group-text bi bi-at" id="inputGroupPrepend"></span>
                                                <input type="email" name="email" class="form-control" id="yourEmail"
                                                    required>
                                                <div class="invalid-feedback">¡Por favor ingrese una dirección de correo
                                        ...
                                        <div class="col-12">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="acceptTerms">Estoy de acuerdo y
                                                    acepto los <a href="#">Términos y condiciones</a></label>
                                                <div class="invalid-feedback">Debe estar de acuerdo antes de enviar.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <p class="small mb-0">¿Ya tienes una cuenta? <a href="login.php">Inicia
                                                    sesión</a></p>
                                        </div>
                                    </form>
